...
async function checkAvailability(refreshToken, startTime, endTime, calendarId = "primary") {
...
async function createEvent(refreshToken, eventData, calendarId = "primary") {
  const calendar = getAuthenticatedCalendarClient(refreshToken);
...
async function updateEvent(refreshToken, eventId, eventData, calendarId = "primary") {
  const calendar = getAuthenticatedCalendarClient(refreshToken);
...
async function deleteEvent(refreshToken, eventId, calendarId = "primary") {
  const calendar = getAuthenticatedCalendarClient(refreshToken);
